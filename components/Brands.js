...
function Brands() {
  return (
    <div className='lg:px-52 flex lg:flex-row flex-wrap lg:justify-between pb-6 gap-6 px-20'>
        <img src='https://nft-29rm65xpk-namyakhan.vercel.app/images/logos/venly-logo.svg'></img>
        ...
        <img src='https://nft-29rm65xpk-namyakhan.vercel.app/images/logos/trustWallet-logo.svg'></img>
    </div>
  )
}
